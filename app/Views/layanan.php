...
<head>
  ...
  <title>Layanan Hukum - Ariyanto & Rekan</title>
    ...
    <div class="container-fluid container-xl position-relative d-flex align-items-center justify-content-between">
      ...
      <nav id="navmenu" class="navmenu">
        <ul>
          ...
          <li><a href="" class="active">Layanan Hukum</a></li>
  ...
  <main class="main">
    ...
    <div class="page-title dark-background">
      <div class="container position-relative">
        ...
        <nav class="breadcrumbs">
          <ol>
            <li><a href="beranda">Beranda</a></li>
            <li class="current">Layanan Hukum</li>
          </ol>
        </nav>
      </div>
    </div><!-- End Page Title -->
    ...
    <section class="why-us py-5">
      <div class="container">
        ...
        <!-- TITLE -->
        <div class="section-title-l mb-4">
        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            ...
            <div class="why-item d-flex mb-4">
              <div class="why-number">1</div>
              <div class="why-text">
                Integritas tanpa kompromi dan nilai-nilai tata kelola yang baik sebagai fondasi utama
                dalam mendukung keberhasilan pencapaian tujuan klien.
              </div>
            </div>
            ...
            <div class="why-item d-flex">
              ...
              <div class="why-text">
                Struktur tim yang profesional dan efektif, guna memberikan layanan hukum yang efisien secara biaya
          ...
          <div class="col-lg-6">
            ...
            <div class="why-item d-flex mb-4">
              ...
              <div class="why-text">
                Pendekatan berbasis solusi, dengan memberikan nasihat komersial yang inovatif, tepat, dan 
                berlandaskan pertimbangan hukum yang kuat.
              </div>
            </div>
            ...
            <div class="why-item d-flex">
              ...
              <div class="why-text">
                Budaya kerja yang berorientasi pada pembentukan dan pemeliharaan hubungan jangka panjang dengan klien
              </div>
            </div>
